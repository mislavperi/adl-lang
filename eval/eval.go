...
func Eval(node ast.Node, environment *object.Environment) object.Object {
	...
	case *ast.BlockStatement:
		return evalBlockStatements(node, environment)
	...
	case *ast.FnLiteral:
		...
		body := node.Body
		return &object.Function{Parameters: params, Env: environment, Body: body}
...
func evalBlockStatements(block *ast.BlockStatement, environment *object.Environment) object.Object {
	var result object.Object
